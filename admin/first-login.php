...
<html>
<head>
	<title>StudioBooth - <?php echo $FullName; ?> - First Login</title>
	...
	if(trim($error_msg) == '')
	{
		...
		<div align="center">
			<div style="width:800px; text-align:left;">
				<div class="title-row">
					<h1 class="title">Chanage Password</h1>
				</div>
				<br />
				<div style="font-size:16px;">
					Hi <?php echo $FullName; ?>, This might be your first login. Please reset your password first.
				</div>
				<br />
